...
with st.expander("ℹ️ - About this interface", expanded=True):
    ...
    st.write(
        ("The *Kool - Competency Extractor* app is an easy-to-use "
            ...
            " of the model [Galactica](https://github.com/paperswithcode/galai)."
            " For further information about this model see the [original paper](https://galactica.org/static/paper.pdf) "
            " introduced by the [Galactica team](https://galactica.org/).")
    )
    ...
    with c1:
        ...
        model_version = st.selectbox(
            ...
            help=("This is the version of the model you want to use. "
                  ...
                  "The number in parenthesis is the number of parameters."),
        )
